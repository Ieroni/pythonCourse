print('Task #38')
# from task_38_libr import read_cont, add_cont, find_cont,\
#                          change_cont, del_cont

# показывает справочник целиком
def read_cont():
    file = open('8th_Seminar\sample.txt', 'r', encoding='UTF-8')
    data = file.readlines()
    file.close()
    for contact in data:
        print(contact)
...
def add_cont():
    file = open ('8th_Seminar\sample.txt', 'a', encoding='UTF-8')
...
def del_cont():
    with open('8th_Seminar\sample.txt', 'r', encoding="utf-8") as f:
